...
```{r}
# Modified function to handle different prefixes for each type
process_tables <- function(tables, table_names, prefix, type_name) {
  # Add cell_line column to each table by removing the prefix
...
# SE tables
SE_tables <- list(SE_1205Lu, SE_451Lu, SE_WM793, SE_SKMEL24, SE_SKMEL5, SE_SKMEL28)
SE_names <- c("SE_1205Lu", "SE_451Lu", "SE_WM793", "SE_SKMEL24", "SE_SKMEL5", "SE_SKMEL28")
SE_combined <- process_tables(SE_tables, SE_names, "SE_", "SE")

# A3SS tables
A3SS_tables <- list(A3SS_1205Lu, A3SS_451Lu, A3SS_WM793, A3SS_SKMEL24, A3SS_SKMEL5, A3SS_SKMEL28)
A3SS_names <- c("A3SS_1205Lu", "A3SS_451Lu", "A3SS_WM793", "A3SS_SKMEL24", "A3SS_SKMEL5", "A3SS_SKMEL28")
A3SS_combined <- process_tables(A3SS_tables, A3SS_names, "A3SS_", "A3SS")

# A5SS tables
A5SS_tables <- list(A5SS_1205Lu, A5SS_451Lu, A5SS_WM793, A5SS_SKMEL24, A5SS_SKMEL5, A5SS_SKMEL28)
A5SS_names <- c("A5SS_1205Lu", "A5SS_451Lu", "A5SS_WM793", "A5SS_SKMEL24", "A5SS_SKMEL5", "A5SS_SKMEL28")
A5SS_combined <- process_tables(A5SS_tables, A5SS_names, "A5SS_", "A5SS")

# MXE tables
MXE_tables <- list(MXE_1205Lu, MXE_451Lu, MXE_WM793, MXE_SKMEL24, MXE_SKMEL5, MXE_SKMEL28)
MXE_names <- c("MXE_1205Lu", "MXE_451Lu", "MXE_WM793", "MXE_SKMEL24", "MXE_SKMEL5", "MXE_SKMEL28")
