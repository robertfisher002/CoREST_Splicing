...
```{r}
splice_expression_compares <- splice_expression_compares %>% 
...
fontsize_row = 8 - nrow(splice_expression_compares) / 15
...
```{r}
pdf(file="splice_expression_compare_heatmap_2.pdf", width = 4, height = 7)
splice_expression_compare_heatmap
dev.off()
```
